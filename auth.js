...
const otpValidation = [ body('otpToken').notEmpty().withMessage('OTP token is required'), body('otp').isLength({ min: 4, max: 4 }).isNumeric().withMessage('OTP must be 4 digits')];
const resendOTPValidation = [ body('otpToken').notEmpty().withMessage('OTP token is required')];
